...
// CSS는 styles/main.css 에서 관리 (경로는 페이지 깊이에 따라 변수로 주입)
...
<style>
  :root { --c-primary:#1a5c3a; --c-secondary:#166534; --c-accent:#166534;
    ...
    --c-active-bg:#e6f4f0; --c-active-border:#166534; }
</style>
</head>
<body>
<div class="top-bar">
...
<style>
  :root { --c-primary:#1e3a5f; --c-secondary:#1e4d8c; --c-accent:#1e4d8c;
    ...
    --c-active-bg:#ebf4ff; --c-active-border:#1e4d8c; }
</style>
</head>
<body>
<div class="top-bar">
...
<style>
  :root { --c-primary:#7b341e; --c-secondary:#c05621; --c-accent:#c05621;
    ...
    --c-active-bg:#fff5eb; --c-active-border:#c05621; }
